...
- 解决：Generator 需要手动控制next(...)执行的问题、真正实现了用同步的方式书写异步代码；
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200913204740.png" alt="截屏2020-09-13 下午8.47.36" style="zoom:50%;" /><img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200913204809.png" alt="截屏2020-09-13 下午8.48.02" style="zoom:50%;" />
