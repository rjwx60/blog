...
<img src="/Image/Basics/Special/Mode/3.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/2.png" style="zoom:50%;" align="" />

<img src="/Image/Basics/Special/Data/3.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/10.png" style="zoom:50%;" align="" />
...
- 注意：**<u>JSON.stringify() 转换过程使用了 toString；</u>**
  ...
  - <img src="/Image/Basics/Special/Data/11.png" style="zoom:50%;" align="" />
  - <img src="/Image/Basics/Special/Data/12.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/13.png" style="zoom:50%;" align="" />
...
- 选择机制优先度(一般值)：valueOf > toString：
  - <img src="/Image/Basics/Special/Data/15.png" style="zoom:50%;" align="" />
- 选择机制优先度(Date对象)：valueOf < toString：若强制使用 Date 的 valueOf，则须使用一元加号 (+)，强制转换它为数字类型：
  - <img src="/Image/Basics/Special/Data/16.png" style="zoom:50%;" align="" />
- 强制将某对象的 valueOf、toString 方法，均覆写为返回值为对象会报错；
  - <img src="/Image/Basics/Special/Data/17.png" style="zoom:50%;" align="" />
- 引入 Symbol 类型后，JS 会优先调用对象的 [Symbol.toPrimitive]，来转为原始类型：
  - <img src="/Image/Basics/Special/Data/18.png" style="zoom:50%;" align="" />
  - <img src="/Image/Basics/Special/Data/19.png" style="zoom:50%;" align="" />
- 空对象与空数组的 valueOf & toString 方法；
  - <img src="/Image/Basics/Special/Data/20.png" style="zoom:50%;" align="" />
- 特殊：引擎会将 花括号开头 { 视为一个区块语句的开头而忽略掉；
  - 故例1实际效果为+{} 但不同浏览器引擎对此种处理不一致，有些返回 NaN，有些返回 "[object Object][object Object]"
  - <img src="/Image/Basics/Special/Data/21.png" style="zoom:50%;" align="" />
- 其他示例
  - <img src="/Image/Basics/Special/Data/22.png" style="zoom:50%;" align="" />
...
- 空函数、undefined、Symbol 返回 null、循环引用报错、含 toJSON 则调用
  - <img src="/Image/Basics/Special/Data/23.png" style="zoom:50%;" align="" />



##### 3-1-3-4、ToString 操作

<img src="/Image/Basics/Special/Data/24.png" style="zoom:50%;" align="" />
...
- \+ 操作符转换规则：
  ...
  - 若均没有，则进行加法运算；
    ...
    - 注意："x + ''  相当于 String(x)
    - <img src="/Image/Basics/Special/Data/25.png" style="zoom:50%;" align="" />
    - <img src="/Image/Basics/Special/Data/32.png" style="zoom:50%;" align="" />
...
- \+ x 或 x - 0 或 x * 1 或 x / 1 相当于 Number( x ) ；且 ++ 加变量，而不能加常量；
  ...
  - <img src="/Image/Basics/Special/Data/26.png" style="zoom:50%;" align="" />

- null 在计算时候转换为0，效果等同 0；

  - <img src="/Image/Basics/Special/Data/27.png" style="zoom:50%;" align="" />

- \>、<、<=、>= 转换规则；

  - <img src="/Image/Basics/Special/Data/28.png" style="zoom:50%;" align="" />
  - <img src="/Image/Basics/Special/Data/29.png" style="zoom:50%;" align="" />

- ~x 相当于 -(x+1)；!!x 相当于 Boolean( x )；

  - <img src="/Image/Basics/Special/Data/30.png" style="zoom:50%;" align="" />

- 其他示例：

  - <img src="/Image/Basics/Special/Data/31.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/33.png" style="zoom:50%;" align="" />

<img src="/Image/Basics/Special/Data/34.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/1.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/4.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/5.png" style="zoom:50%;" align="" />

<img src="/Image/Basics/Special/Data/6.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/7.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/8.png" style="zoom:50%;" align="" />



##### 3-2-6、总结

<img src="/Image/Basics/Special/Data/9.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/35.png" style="zoom:70%;" align="" />

- JS 表达式包含表达式时，运算顺序是从左至右；

- 加号优先级 > 三目运算符 

  - <img src="/Image/Basics/Special/Data/36.png" style="zoom:50%;" align="" />

- 模数运算保留符号，注意后2个，前者结果为-1，后者结果为NaN

  - <img src="/Image/Basics/Special/Data/37.png" style="zoom:50%;" align="" />
...
<img src="/Image/Basics/Special/Data/38.png" style="zoom:50%;" align="" />

<img src="/Image/Basics/Special/Data/39.png" style="zoom:50%;" align="" />

<img src="/Image/Basics/Special/Data/40.png" style="zoom:50%;" align="" />
