...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091133.png" style="zoom:50%;" align="left" />

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091134.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091135.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091136.png" style="zoom:50%;" align="left"/>
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091137.png" style="zoom:50%;" align="left"/>
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091138.png" style="zoom:50%;" align="left"/>
...
- <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091139.png" style="zoom:50%;" align="left"/>

**<u>*两者区别：*</u>**

- prototype：对象且函数才会有此属性；
- `__proto__`：对象皆有的属性，但并非规范属性 (部分浏览器实现，标准属性为 [[Prototype]]
- <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091140.png" style="zoom:50%;" align="left"/>
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091141.png" style="zoom:50%;" align="left"/>

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091142.png" style="zoom:50%;" align="left"/>

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091143.png" style="zoom:50%;" align="left"/>
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091146.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091147.png" style="zoom:50%;" align="left" />

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091148.png" style="zoom:50%;" align="left" />



##### 1-2-6-2、大图解说

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091149.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091150.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091151.png" style="zoom:55%;" align="left"/>
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091152.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091154.png" style="zoom:50%;" align="left"/>

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091155.png" style="zoom:50%;" align="left"/>

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091156.png" style="zoom:50%;" align="left" />
...
- 比如：person.valueOf()；
- <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091157.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091201.png" style="zoom:50%;" align="left" />

- instanceof 工作机制；若修改 prototype 的 值，则会改变原有(图2)

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091202.png" style="zoom:50%;" align="left" />

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091203.png" style="zoom:50%;" align="left" />

- Fun 是单纯的函数，`Fun.__proto__` 属于 Function.prototype，除非 new 出来，否则不属于 Fun.prototype；

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091204.png" style="zoom:50%;" align="left" />

- JS 在访问 str 属性时创建临时 String 对象 (假设叫tmpStr)，并在得到此返回值时销毁临时对象，故此处是 `tmpStr.__proto__` 的值；而引用类型的字面量和基础类型的不一样(图2)；

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091205.png" style="zoom:50%;" align="left" />

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091206.png" style="zoom:50%;" align="left" />

- 对于三种基本类型的字面声明，instanceof 均返回 false；而其他类型的字面量声明则为 true；

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091207.png" style="zoom:50%;" align="left" />

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091208.png" style="zoom:50%;" align="left" />

- `Object.prototype.__proto__` 为 null，但 null 不等于 `Object.prototype`；

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091209.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091210.png" style="zoom:50%;" align="left" />

- **Function instanceof Function**

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091211.png" style="zoom:50%;" align="left" />

- **Foo instanceof Foo**

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091212.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091214.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091215.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091216.png" style="zoom:50%;" align="left" />
...
- <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091217.png" style="zoom:50%;" align="left" />
...
- **<u>父类的静态方法，可被子类继承</u>**；
  ...
  - 因为 Class 作为构造函数的语法糖，同时有 prototype 属性和 `__proto__` 属性，因此同时存在两条继承链：
    ...
    - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091218.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091219.png" style="zoom:50%;" align="left"/>
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091220.png" style="zoom:50%;" align="left" />



##### X-3-1、MVC

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091221.png" style="zoom:50%;" align="left" />
...
- MVC 的 Model
  ...
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091222.png" style="zoom:50%;" align="left" />

- MVC 的 View
  - Controller 和 View 间使用了策略模式，View 引入 Controller 的实例 来实现特定的响应策略，如其中的按钮的 click 事件：
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091223.png" style="zoom:50%;" align="left" />
...
- MVC 的 Controller
  ...
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091224.png" style="zoom:50%;" align="left" />

此处实例化 View 并向对应的 Model 实例注册，当 Model 发生变化时就去通知 View 做更新，这里用到了观察者模式；

最后一步，使用 Controller 初始化：

- <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091225.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091226.png" style="zoom:50%;" align="left" />
...
- MVP 的 Model
  ...
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091227.png" style="zoom:50%;" align="left" />

- MVP 的 View
  - 用户对 View 的操作都转移到了Presenter
  - 待 Presenter 通知 Model 更新后，Presenter 调用 View 提供的接口更新视图(下 this)；
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091228.png" style="zoom:50%;" align="left" />

- MVP 的 Presenter
  - 负责基本的业务逻辑，并管理 从 View 与 View 间的数据流动；
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091229.png" style="zoom:50%;" align="left" />

最后一步，使用 View 初始化：(MVC 用的是 Controller 实例化)

- <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091230.png" style="zoom:50%;" align="left" />
...
- MVVM 的 Model
  ...
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091231.png" style="zoom:50%;" align="left" />
- MVVM 的 View
  - 与 MVC/MVP 不同的是，MVVM 中的 View 通过使用模板语法来声明式的将数据渲染进 DOM
  - VM 对 Model 进行更新时，会通过数据绑定，更新到 View；
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091232.png" style="zoom:50%;" align="left" />
- MVVM 的 ViewModel
  ...
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091233.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200909091234.png" style="zoom:50%;" align="left" />
