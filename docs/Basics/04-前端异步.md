...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092802.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092810.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092814.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092815.png" style="zoom:50%;" align="left" />



##### 7-2-2-2、Errors 处理及封装

注意：使用 fetch 接收到异常状态码均会进入 then 而不是 catch，故需手动处理；

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092816.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092817.png" style="zoom:50%;" align="left" />

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092818.png" style="zoom:50%;" align="left" />



##### 7-2-2-4、Request 封装

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092819.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092820.png" style="zoom:50%;" align="left" />

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092821.png" style="zoom:50%;" align="left" />

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092822.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092823.png" style="zoom:50%;" align="left" />



##### 7-3-3-2、Instance 实例构建

**<u>*利用 createInstance 构建实例、继承 utils 方法，随后为实例增加各个函数方法*</u>**，lib/axios.js

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092824.png" style="zoom:50%;" align="left" />

- 补充 utils 工具方法：
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092825.png" style="zoom:50%;" align="left" />
  - utils 中的 merge 方法：合并对象的属性，相同属性后面的替换前的
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092826.png" style="zoom:50%;" align="left" />
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092827.png" style="zoom:50%;" align="left" />
  - utils 中的 extend 方法：将 b 里面的属性和方法继承给 a , 并且将 b 里面的方法的执行上个下文都绑定到 thisArg
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092828.png" style="zoom:50%;" align="left" />
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092829.png" style="zoom:50%;" align="left" />
  - extend  中的 forEach 能遍历基本数据，数组，对象：
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092830.png" style="zoom:50%;" align="left" />
  - extend 中的  bind 返回一个函数，并且传入的方法执行上下文绑定到 thisArg上
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092831.png" style="zoom:50%;" align="left" />



##### 7-3-3-3、createInstance 详解

<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092832.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092833.png" style="zoom:50%;" align="left" />

- Axios 核心即 request 方法，上面所有方法都通过调用了 `this.request` 方法(包含 Promise 的链式调用与中间件思想)

  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092834.png" style="zoom:50%;" align="left" />

  - 补充：拦截器用于将请求或响应在 then 或 catch 处理前拦截

  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092835.png" style="zoom:50%;" align="left" />

  - 所以：此段代码作用是为 chain 的头尾添加请求拦截器和相应拦截器 

  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092836.png" style="zoom:50%;" align="left" />
  ...
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092837.png" style="zoom:50%;" align="left" />
  ...
  - <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092838.png" style="zoom:50%;" align="left" />



##### 7-3-3-5、dispatchRequest 
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092839.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092840.png" style="zoom:50%;" align="left" />
...
<img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092841.png" style="zoom:50%;" align="left" />

分类：Hot Observable & Cold Observable

- 定义：冷热相对于生产者而言，若订阅时，已有生产者准备好，即为 Hot；
- 而若：每次订阅均需产生一个新的生产者则为 Cold；
- <img src="https://leibnize-picbed.oss-cn-shenzhen.aliyuncs.com/img/20200908092842.png" style="zoom:50%;" align="left" />
